<div class="box box-primary">
    ...
    <div class="box-body">
        @if(count($previous->maximumHeartRate) > 0)
            <table id="example2" cellspacing="0" class="table table-bordered table-hover data-table">
                ...
                <tbody>
                @forelse($previous->maximumHeartRate as $value)
                    <tr>
...
<div class="box box-primary">
    ...
    <div class="box-body">
        @if(count($previous->minimumHeartRate) > 0)
            <table id="example2" cellspacing="0" class="table table-bordered table-hover data-table">
                <thead>
                <tr>
                    <th>{{ trans('strings.protocols') }}</th>
                ...
                <tbody>
                @forelse($previous->minimumHeartRate as $value)
                    <tr>
                        <td>{{$value->protocol->name}}</td>
                        <td>{{$value->protocol->formula}}</td>
                        <td>{{$value->result}}</td>
...
<div class="box box-primary">
    ...
    <div class="box-body">
        @if(count($previous->reserveHeartRate) > 0)
            <table id="example2" cellspacing="0" class="table table-bordered table-hover data-table">
                <thead>
                <tr>
                    <th>{{ trans('strings.protocols') }}</th>
                ...
                <tbody>
                @forelse($previous->reserveHeartRate as $value)
                    <tr>
                        <td>{{$value->protocol->name}}</td>
                        <td>{{$value->protocol->formula}}</td>
                        <td>{{$value->result}}</td>
...
<div class="box box-primary">
    ...
    <div class="box-body">
        @if(count($previous->maximumVo2) > 0)
            <table id="example2" cellspacing="0" class="table table-bordered table-hover data-table">
                <thead>
                <tr>
                    <th>{{ trans('strings.protocols') }}</th>
...
<div class="box box-primary">
    ...
    <div class="box-body">
        @if(count($previous->trainingVo2) > 0)
            <table id="example2" cellspacing="0" class="table table-bordered table-hover data-table">
                <thead>
                <tr>
                    <th>{{ trans('strings.protocols') }}</th>
                ...
                <tbody>
                @forelse($previous->trainingVo2 as $value)
                    <tr>
                        <td>{{$value->protocol->name}}</td>
                        <td>{{$value->protocol->formula}}</td>
                        <td>{{$value->result}}</td>
...
<div class="box box-primary">
    ...
    <div class="box-body">
        @if(count($previous->targetZone) > 0)
            <table id="example2" cellspacing="0" class="table table-bordered table-hover data-table">
                <thead>
                <tr>
                    <th>{{ trans('strings.protocols') }}</th>
                ...
                <tbody>
                @forelse($previous->targetZone as $value)
                    <tr>
                        <td>{{$value->protocol->name}}</td>
                        <td>{{$value->protocol->formula}}</td>
                        <td>{{$value->result}}</td>
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">{{trans('strings.resistance')}}</h3>
        <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="" data-original-title="Collapse">
    ...
    <div class="box-body">
        <div class="row">
            <?php $supine = supine($previous->id); $squat = squat($previous->id);?>
...
<div class="box box-primary">
    ...
    <div class="box-body">
        @if(count($previous->flexitest) > 0)
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if($previous->flexitest->abduction_shoulders)
                        <div class="form-group">
                            {!! Form::label('abduction_shoulders', trans('strings.abduction_shoulders'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('abduction_shoulders', $previous->flexitest->abduction_shoulders, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.abduction_shoulders')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if($previous->flexitest->lateral_trunk_flexion)
                        <div class="form-group">
                            {!! Form::label('lateral_trunk_flexion', trans('strings.lateral_trunk_flexion'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('lateral_trunk_flexion', $previous->flexitest->lateral_trunk_flexion, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.lateral_trunk_flexion')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if(!is_null($previous->flexitest->leg_hyperextension))
                        <div class="form-group">
                            {!! Form::label('leg_hyperextension', trans('strings.leg_hyperextension'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('leg_hyperextension', $previous->flexitest->leg_hyperextension, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.leg_hyperextension')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if(!is_null($previous->flexitest->elbow_flexion))
                        <div class="form-group">
                            {!! Form::label('elbow_flexion', trans('strings.elbow_flexion'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('elbow_flexion', $previous->flexitest->elbow_flexion, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.elbow_flexion')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if(!is_null($previous->flexitest->elbow_hyperextension))
                        <div class="form-group">
                            {!! Form::label('elbow_hyperextension', trans('strings.elbow_hyperextension'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('elbow_hyperextension', $previous->flexitest->elbow_hyperextension, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.elbow_hyperextension')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if(!is_null($previous->flexitest->fist_flexion))
                        <div class="form-group">
                            {!! Form::label('fist_flexion', trans('strings.fist_flexion'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('fist_flexion', $previous->flexitest->fist_flexion, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.fist_flexion')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if(!is_null($previous->flexitest->fist_extension))
                        <div class="form-group">
                            {!! Form::label('fist_extension', trans('strings.fist_extension'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('fist_extension', $previous->flexitest->fist_extension, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.fist_extension')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if(!is_null($previous->flexitest->horizontal_shoulder_abduction))
                        <div class="form-group">
                            {!! Form::label('horizontal_shoulder_abduction', trans('strings.horizontal_shoulder_abduction'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('horizontal_shoulder_abduction', $previous->flexitest->horizontal_shoulder_abduction, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.horizontal_shoulder_abduction')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if(!is_null($previous->flexitest->hip_flexion))
                        <div class="form-group">
                            {!! Form::label('hip_flexion', trans('strings.hip_flexion'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('hip_flexion', $previous->flexitest->hip_flexion, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.hip_flexion')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if(!is_null($previous->flexitest->trunk_hyperextension))
                        <div class="form-group">
                            {!! Form::label('trunk_hyperextension', trans('strings.trunk_hyperextension'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('trunk_hyperextension', $previous->flexitest->trunk_hyperextension, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.trunk_hyperextension')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if(!is_null($previous->flexitest->haunch_flexion))
                        <div class="form-group">
                            {!! Form::label('haunch_flexion', trans('strings.haunch_flexion'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('haunch_flexion', $previous->flexitest->haunch_flexion, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.haunch_flexion')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if(!is_null($previous->flexitest->haunch_extension))
                        <div class="form-group">
                            {!! Form::label('haunch_extension', trans('strings.haunch_extension'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('haunch_extension', $previous->flexitest->haunch_extension, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.haunch_extension')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if(!is_null($previous->flexitest->leg_flexion))
                        <div class="form-group">
                            {!! Form::label('leg_flexion', trans('strings.leg_flexion'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('leg_flexion', $previous->flexitest->leg_flexion, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.leg_flexion')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if(!is_null($previous->flexitest->plantar_dorsiflexion))
                        <div class="form-group">
                            {!! Form::label('plantar_dorsiflexion', trans('strings.plantar_dorsiflexion'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('plantar_dorsiflexion', $previous->flexitest->plantar_dorsiflexion, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.plantar_dorsiflexion')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    @if(!is_null($previous->flexitest->plantar_flexion))
                        <div class="form-group">
                            {!! Form::label('plantar_flexion', trans('strings.plantar_flexion'), ['class' => '']) !!}
                            <div class="input-group">
                                {!! Form::text('plantar_flexion', $previous->flexitest->plantar_flexion, ['readonly', 'class' => 'decimal form-control', 'placeholder' => trans('strings.plantar_flexion')]) !!}
                            </div>
                        </div>
                    @else
                        <div class="form-group">
