<div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 text-center">
        <div class="form-group">
            <img alt="Hiperextensão de Perna" class="img-responsive" style="display: initial" src="{{imageurl('flexitest', 'leg_hyperextension_1.png', 0)}}">
        </div>
        <div class="form-group">
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 text-center">
        <div class="form-group">
            <img alt="Hiperextensão de Perna" class="img-responsive" style="display: initial" src="{{imageurl('flexitest', 'leg_hyperextension_2.png', 0)}}">
        </div>
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 text-center">
        <div class="form-group">
            <img alt="Hiperextensão de Perna" class="img-responsive" style="display: initial" src="{{imageurl('flexitest', 'leg_hyperextension_3.png', 0)}}">
        </div>
        <div class="form-group text-center">
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 text-center">
        <div class="form-group">
            <img alt="Hiperextensão de Perna" class="img-responsive" style="display: initial" src="{{imageurl('flexitest', 'leg_hyperextension_4.png', 0)}}">
        </div>
        <div class="form-group text-center">
