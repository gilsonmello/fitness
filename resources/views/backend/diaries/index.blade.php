@section ('title', trans('menus.diaries.index'))
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('menus.diaries.index') }}</li>
    </ol>
</section>
@endsection
...
<div class="pull-right" style="margin-bottom:10px">
    <a href="{{ route('backend.diaries.create') }}" class="btn btn-primary btn-xs">
        {{ trans('menus.diaries.create') }}
    </a>
...
<div class="box box-primary">
    ...
    {!! Form::open(array('route' => array('backend.diaries.index'), 'class' => '', 'method' => 'get'))  !!}
        <div class="box-body">
            <div class="row">
