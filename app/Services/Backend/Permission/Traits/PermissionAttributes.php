 ...
 * Time: 22:01
 */
namespace App\Services\Backend\Permission\Traits;
...
trait PermissionAttributes{
    ...
    public function getEditButtonAttribute() {
        return '<a href="'.route('backend.permissions.edit', $this->id).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="' . trans('crud.edit_button') . '"></i></a>';
    }
    ...
    public function getDeleteButtonAttribute() {
        return '<a href="'.route('backend.permissions.destroy', $this->id).'" data-method="delete" class="btn btn-xs btn-danger"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="' . trans('crud.delete_button') . '"></i></a>';
    }
