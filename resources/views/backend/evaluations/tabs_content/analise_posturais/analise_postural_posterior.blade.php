<div class="tab-pane" id="tab_analise_postural_posterior">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8" id="visualizar">
            <img src="{{imageurl('analise_postural', !is_null($evaluation->analisePosturalPosterior) ? $evaluation->analisePosturalPosterior->img : NULL, 400, true)}}" id="img-reader" style="width: 100%; height: 380px;">
        </div>
    </div>
    <br>
    {!! Form::close() !!}
