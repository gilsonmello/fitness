...
@section ('title', trans('menus.tags.index') . ' | ' . trans('menus.tags.create'))
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="{{ route('backend.tags.index') }}">
                    {{ trans('menus.tags.index') }}
                </a>
            </li>
            <li class="active">{{ trans('menus.tags.create') }}</li>
        </ol>
    </section>
@endsection

@section('content')
{!! Form::open(['route' => 'backend.tags.store', 'class' => '', 'role' => 'form', 'method' => 'post', 'files' => true]) !!}
