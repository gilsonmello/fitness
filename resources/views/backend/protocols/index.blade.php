...
<div class="box box-primary">
    ...
    {!! Form::open(array('route' => array('backend.protocols.index'), 'class' => '', 'method' => 'get'))  !!}
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12 col-sm-6 col-lg-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('ProtocolController@index:name', $name, ['class' => 'form-control']  ) !!}
                    </div>
                </div>
                <div class="col-md-6 col-xs-12 col-sm-6 col-lg-6">
                    <div class="form-group">
                        {!! Form::label('ProtocolController@index:formula',  trans('strings.formula'), ['class' => '']) !!}
                        {!! Form::text('ProtocolController@index:formula', $formula, ['class' => 'form-control']  ) !!}
                    </div>
                </div>
            </div>
        </div>
