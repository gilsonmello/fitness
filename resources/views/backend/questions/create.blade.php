...
@section('content_header')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="{{ route('backend.questions') }}">
...
@section('content')
    {!! Form::open(['route' => 'backend.question_group.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) !!}
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-1">
                {!! Form::label('description', trans('strings.title').'*', ['class' => '']) !!}
            </div>
            <div class="col-xs-12 col-sm-10 col-md-10 col-lg-11 pull-right">
                {!! Form::textarea('description', null, ['class' => 'form-control textarea', 'placeholder' => trans('strings.title')]) !!}
            </div>
        </div>
