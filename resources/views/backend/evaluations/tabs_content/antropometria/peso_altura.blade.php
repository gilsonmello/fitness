<form class="" method="POST" action="{{ route('backend.evaluations.update_weight_and_height', ['id' => $evaluation->id]) }}" id="update_weight_and_height">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group">
                ...
                <div class="input-group">
                    {!! Form::text('weight', !is_null($evaluation->anthropometry) ? $evaluation->anthropometry->weight : NULL, ['class' => 'form-control cm', 'placeholder' => trans('strings.weight')]) !!}
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="input-group">
                {!! Form::text('height', !is_null($evaluation->anthropometry) ? $evaluation->anthropometry->height : NULL, ['class' => 'form-control cm', 'placeholder' => trans('strings.height')]) !!}
