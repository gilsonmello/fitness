 ...
 * Time: 22:01
 */
namespace App\Services\Backend\Category\Traits;
use Carbon\Carbon;
...
trait CategoryAttributes{
    ...
    public function getDeleteButtonAttribute() {
        return '<a href="'.route('backend.categories.destroy', $this->id).'" data-method="delete" class="btn btn-xs btn-danger"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="' . trans('crud.delete_button') . '"></i></a>';
    }
