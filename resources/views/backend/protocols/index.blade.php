...
@section('content')
    ...
    <div class="pull-right" style="margin-bottom:10px">
        <a href="{{ route('backend.protocols.create') }}" class="btn btn-primary btn-xs">
            {{ trans('menus.protocols.create') }}
        </a>
    ...
    <div class="box box-primary">
        ...
        {!! Form::open(array('route' => array('backend.protocols.index'), 'class' => 'form-horizontal', 'method' => 'get'))  !!}
        <div class="box-body">
            <div class="row">
                {!! Form::hidden('f_submit', '1') !!}
                {!! Form::label('ProtocolController@index:name',  trans('strings.name'), ['class' => 'col-md-2 control-label']) !!}
                <div class="col-md-10">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <table id="example2" cellspacing="0" class="table table-bordered table-hover data-table">
                        ...
                        <tbody>
                        @can('backend.questions.index', NULL)
                            @forelse($protocols as $value)
                                <tr>
                                    <td>{!! $value->name !!}</td>
