 ...
 * Time: 22:01
 */
namespace App\Services\Backend\Package\Traits;
use Carbon\Carbon;
...
trait PackageAttributes{
    ...
    public function getEditButtonAttribute() {
        return '<a href="'.route('backend.packages.edit', $this->id).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="' . trans('crud.edit_button') . '"></i></a>';
    }
    ...
    public function getDeleteButtonAttribute() {
        return '<a href="'.route('backend.packages.destroy', $this->id).'" data-method="delete" class="btn btn-xs btn-danger"><i class="fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="' . trans('crud.delete_button') . '"></i></a>';
    }
