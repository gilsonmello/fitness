...
@section('content_header')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="{{ route('backend.protocols.index') }}">{{ trans('menus.users.index') }}</a>
            </li>
...
{!! Form::model($auth, ['route' => ['backend.auth.update', $auth->id], 'class' => '', 'role' => 'form', 'method' => 'put']) !!}
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                <div class="form-group">
                    ...
                    {!! Form::text('email', $auth->email, ['readonly', 'class' => 'form-control', 'placeholder' => trans('strings.email')]) !!}
                </div>
            </div>
        </div>
        <div class="row">
