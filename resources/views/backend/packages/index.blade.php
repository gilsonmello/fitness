...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('menus.packages.index') }}</li>
    </ol>
</section>
@endsection
...
<div class="pull-right" style="margin-bottom:10px">
    <a href="{{ route('backend.packages.create') }}" class="btn btn-primary btn-xs">
        {{ trans('menus.packages.create') }}
    </a>
...
<div class="box box-primary">
    ...
    {!! Form::open(array('route' => array('backend.packages.index'), 'class' => '', 'method' => 'get'))  !!}
        <div class="box-body">
            <div class="row">
